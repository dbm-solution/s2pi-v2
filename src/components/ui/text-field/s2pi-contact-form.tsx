...
import { S2PIHeading2, S2PIBody } from "../typography/typography"
      ...
      <Card className="max-w-2xl mx-auto">
        <CardContent className="p-8 text-center">
          <div className="mb-6">
            ...
            <S2PIHeading2>Message envoyé avec succès !</S2PIHeading2>
            <S2PIBody>Merci pour votre demande. Notre équipe vous contactera dans les plus brefs délais.</S2PIBody>
          </div>
  ...
  return (
    <Card className="max-w-4xl mx-auto">
      <CardHeader className="text-center pb-8">
        <CardTitle>
          <S2PIHeading2>Contactez nos experts S2PI</S2PIHeading2>
        </CardTitle>
        <S2PIBody>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="border-t pt-6">
            <S2PIHeading2 className="text-left mb-6">Questions techniques</S2PIHeading2>
          ...
          {submitStatus === "error" && (
            <div className="p-4 bg-red-50 border border-red-200 rounded-md">
              <S2PIBody className="text-red-700 mb-0">
