...
const infoCardVariants = cva("relative overflow-hidden transition-all duration-300 ease-in-out", {
  variants: {
    ...
    transition: {
      ...
      slideIn: "translate-x-0 transition-transform duration-300 ease-in-out",
      slideOut: "translate-x-0 transition-transform duration-300 ease-in-out",
      scaleIn: "scale-100 transition-transform duration-300 ease-in-out",
      scaleOut: "scale-100 transition-transform duration-300 ease-in-out",
      rotateIn: "rotate-0 transition-transform duration-300 ease-in-out",
      rotateOut: "rotate-0 transition-transform duration-300 ease-in-out",
      bounceIn: "bounce-in transition-transform duration-300 ease-in-out",
      slideInLeft: "translate-x-0 transition-transform duration-300 ease-in-out",
      slideOutLeft: "translate-x-0 transition-transform duration-300 ease-in-out",
      slideInRight: "translate-x-0 transition-transform duration-300 ease-in-out",
      slideOutRight: "translate-x-0 transition-transform duration-300 ease-in-out",
      slideInTop: "translate-y-0 transition-transform duration-300 ease-in-out",
      slideOutTop: "translate-y-0 transition-transform duration-300 ease-in-out",
      slideInBottom: "translate-y-0 transition-transform duration-300 ease-in-out",
      slideOutBottom: "translate-y-0 transition-transform duration-300 ease-in-out",
    },
  },
  defaultVariants: {
    variant: "primary",
